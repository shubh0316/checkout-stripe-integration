...
export function Summary({ formData }: SummaryProps) {
  return (
    <Card className="border-red-200 bg-red-50">
      <CardHeader>
        <CardTitle className="text-red-900 text-2xl">Application Summary</CardTitle>
      ...
      <CardContent>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-lg text-red-700">
          ...
          <div><b className="text-red-800">Destination:</b> {formData.country}</div>
          <div className="md:col-span-2"><b className="text-red-800">Participant:</b> {formData.salutation} {formData.firstName} {formData.lastName}</div>
          ...
          <div className="md:col-span-2"><b className="text-red-800">Address:</b> {formData.address}, {formData.city}, {formData.postalCode}, {formData.countryOfResidence}</div>
          <div><b className="text-red-800">Phone:</b> {formData.phone}</div>
          <div><b className="text-red-800">Email:</b> {formData.email}</div>
          {formData.module && (
            <div className="md:col-span-2"><b className="text-red-800">Module:</b> {formData.module}</div>
          )}
          <div className="md:col-span-2"><b className="text-red-800">Insurance Status:</b>{formData.insurance}</div>
          <div className="md:col-span-2"><b className="text-red-800">Experience:</b> {formData.experience}</div>
          <div className="md:col-span-2"><b className="text-red-800">Motivation:</b> {formData.motivation}</div>
